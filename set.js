...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~qqxzTLZI#YSwMVS7fjlbmU8MecrYilRzQXiNLlJEL3y3q-v935cQ", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "254713145618,254103852982", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
OWNER_NAME: process.env.OWNER_NAME || "Ongeri Brian", // Input Yours custom...(Maintain font for Flow)
